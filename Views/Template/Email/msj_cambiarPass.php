		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Solicitud de acceso para el usuario: <strong><?= $data['correo']; ?></strong></p>
					<p>Has solicitado recuperar acceso a tu cuenta, accede al siguiente enlace para cambiar tu contraseña. </p>
					<p class="x_text_white">
					<a href="<?= $data['url_recovery']; ?>" target="_blank" class="x_button_link x_link_blue">Confirmar datos</a>
					</p>
					<br>
					<p>O puedes copiar y pegar la siguiente dirección en tu navegador.</p>
